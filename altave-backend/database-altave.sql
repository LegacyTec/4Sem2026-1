...
INSERT INTO contrato_usuario (id_contrato, id_usuario) VALUES (21, 21);
INSERT INTO contrato_usuario (id_contrato, id_usuario) VALUES (21, 22);

-- Carlos no contrato 2
INSERT INTO contrato_usuario (id_contrato, id_usuario) VALUES (22, 22);

--- Ativos
INSERT INTO ativo (status, fabricante, tipo, periodicidade_manutencao, descricao, data_instalacao, predio, planta, id_contrato)
VALUES ('OPERACIONAL', 'Intelbras', 'CAMERA', 30, 'Câmera de segurança - entrada principal', DATE '2024-02-10', 'Prédio A', 'Planta 1', 21);

-- Ordem de manutenção
INSERT INTO ordem_manutencao 
(nome_ordem, data_inicio, tipo_manutencao, id_ativo, descricao, status)
VALUES 
('Inspeção câmera entrada', DATE '2025-01-10', 'PREVENTIVA', 22 , 
 'Verificação de lente, foco e conexão', 'PENDENTE');

-- Ordem_usuario
 INSERT INTO ordem_usuario (id_ordem_manutencao, id_usuario) VALUES (22, 22);
